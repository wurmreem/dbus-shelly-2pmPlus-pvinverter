...
class DbusShelly1pmService:
  def __init__(self, servicename, paths, productname='Shelly 1PM Plus', connection='Shelly 1PM Plus HTTP JSON service'):
  ...
  def _update(self):   
    try:
       ...
       self._dbusservice['/Ac/Power'] = self._dbusservice['/Ac/' + pvinverter_phase + '/Power'] *3
       self._dbusservice['/Ac/Energy/Forward'] = self._dbusservice['/Ac/' + pvinverter_phase + '/Energy/Forward'] *3
